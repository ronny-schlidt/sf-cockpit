...
| Subscribers (`2`) | Every org with the package installed, and whether it's behind the latest released version. | `src/ui/subscribers.rs` | `src/app/mod.rs` | `src/sf/push.rs` (`PackageSubscriber`) |
